...
import data from "../../data/direct.json";
import data2 from "../../data/direct-requests.json";
    ...
    render(){
        return(
            <div className="content">
                <Header title="Financiamiento Directo" description="Nos cedes tus facturas, retenemos una garantía y te anticipamos el resto." button="Sincronizar con SII" buttonIcon="SyncIcon" />
                <Tabs sections={
                    [
                        {id:1,caption:"Facturas disponibles",link:"/financiamiento-directo",counter:16},
                        {id:2,caption:"Solicitudes",link:"/financiamiento-directo/solicitudes",counter:3}
                    ]
                } />
                <Switch>
                    <Route path="/financiamiento-directo/solicitudes">
                        <Commands />
                        <div className="list">
                    ...
                    <Route path="/financiamiento-directo">
                        <Commands />
                        <div className="list">
                            <div className="list-header">
                            ...
                            <div className="list-item">
                                ...
                                <div className="list-item-cell list-item-cell-center">
                                    <div className="list-item-btn" onClick={this.financing}>
                                        <div className="list-item-btn-check"></div>
                                        <div className="list-item-btn-caption noselect">Financiar</div>
                                    </div>
                                </div>
                                <div className="list-item-min">
                                    ...
                                    <div className="list-item-super-outstanding">${invoice.amount}</div>
                        ...
                        <div className="list-more">
                            <div className="list-more-btn">Mostrar 38 más</div>
                        </div>
                    </Route>
                </Switch>
            </div>
